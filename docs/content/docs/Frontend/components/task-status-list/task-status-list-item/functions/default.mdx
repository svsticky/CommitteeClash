...
Defined in: [src/components/task-status-list/task-status-list-item.tsx:15](https://github.com/svsticky/CommitteeClash/blob/cf8a63ee123fe6ef8b9cc633622ca8c3bc6fa48a/frontend/src/components/task-status-list/task-status-list-item.tsx#L15)
