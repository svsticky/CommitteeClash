...
Defined in: [src/components/task-status-list/task-status-list-item.tsx:15](https://github.com/svsticky/CommitteeClash/blob/8a31d8fc8422df670b3b4cb3b5fd558ecdeabb90/frontend/src/components/task-status-list/task-status-list-item.tsx#L15)
