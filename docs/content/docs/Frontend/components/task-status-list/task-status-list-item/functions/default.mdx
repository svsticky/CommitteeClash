...
Defined in: [src/components/task-status-list/task-status-list-item.tsx:15](https://github.com/svsticky/CommitteeClash/blob/e5fd1c9fb89fe447a4c38e43ebba51eb1e51230c/frontend/src/components/task-status-list/task-status-list-item.tsx#L15)
