...
Defined in: [src/components/leaderboard/leaderboard-item-component.tsx:16](https://github.com/svsticky/CommitteeClash/blob/cf8a63ee123fe6ef8b9cc633622ca8c3bc6fa48a/frontend/src/components/leaderboard/leaderboard-item-component.tsx#L16)
