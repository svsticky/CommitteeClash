...
Defined in: [src/components/leaderboard/scorebar-component.tsx:13](https://github.com/svsticky/CommitteeClash/blob/8a31d8fc8422df670b3b4cb3b5fd558ecdeabb90/frontend/src/components/leaderboard/scorebar-component.tsx#L13)
