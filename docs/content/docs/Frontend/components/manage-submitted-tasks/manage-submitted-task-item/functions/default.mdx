...
Defined in: [src/components/manage-submitted-tasks/manage-submitted-task-item.tsx:17](https://github.com/svsticky/CommitteeClash/blob/8a31d8fc8422df670b3b4cb3b5fd558ecdeabb90/frontend/src/components/manage-submitted-tasks/manage-submitted-task-item.tsx#L17)
