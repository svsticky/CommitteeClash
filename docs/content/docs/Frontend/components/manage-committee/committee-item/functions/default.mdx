...
Defined in: [src/components/manage-committee/committee-item.tsx:21](https://github.com/svsticky/CommitteeClash/blob/cf8a63ee123fe6ef8b9cc633622ca8c3bc6fa48a/frontend/src/components/manage-committee/committee-item.tsx#L21)
