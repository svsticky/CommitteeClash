...
Defined in: [src/components/manage-possible-tasks/possible-task-item.tsx:17](https://github.com/svsticky/CommitteeClash/blob/42e3ab31b18c9cdd65955be0ecd3ca0a2cb493b5/frontend/src/components/manage-possible-tasks/possible-task-item.tsx#L17)
