...
Defined in: [src/components/manage-possible-tasks/edit-possible-task.tsx:25](https://github.com/svsticky/CommitteeClash/blob/8a31d8fc8422df670b3b4cb3b5fd558ecdeabb90/frontend/src/components/manage-possible-tasks/edit-possible-task.tsx#L25)
