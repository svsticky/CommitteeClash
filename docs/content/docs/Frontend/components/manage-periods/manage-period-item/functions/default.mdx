...
Defined in: [src/components/manage-periods/manage-period-item.tsx:22](https://github.com/svsticky/CommitteeClash/blob/f974faa16c13593c1cc0eea50bf89b045abdabb5/frontend/src/components/manage-periods/manage-period-item.tsx#L22)
