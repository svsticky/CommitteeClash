...
<TypeTable types={[{"name":"runTime","type":"TimeSpan","links":["https://learn.microsoft.com/dotnet/api/system.timespan"],"description":""},{"name":"stoppingToken","type":"CancellationToken","links":["https://learn.microsoft.com/dotnet/api/system.threading.cancellationtoken"],"description":""}]} />
