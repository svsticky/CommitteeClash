...
<TypeTable types={[{"name":"","type":"IActionResult","links":["https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":"An IActionResult containing the status message."}]} />
