...
<h4 className='mb-0 ml-1'>Parameters</h4>
<TypeTable types={[{"name":"PeriodId","type":"Guid","links":["https://learn.microsoft.com/dotnet/api/system.guid"],"description":""}]} />

<h4 className='mb-0 ml-1'>Returns</h4>
<TypeTable types={[{"name":"","type":"IActionResult","links":["https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.iactionresult"],"description":""}]} />
